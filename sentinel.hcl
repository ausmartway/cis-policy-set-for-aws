...
policy "efs-encryption-at-rest-enabled" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/efs-encryption-at-rest-enabled.sentinel?checksum=sha256:049d6f0b387a6c843c1e61981492357005b0946639f12cb3fc9b6fbfedd51cc3"
  enforcement_level = "advisory"
}

policy "iam-no-admin-privileges-allowed-by-policies" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-no-admin-privileges-allowed-by-policies.sentinel?checksum=sha256:55e4852d49635fdaba4220678c7fc9297c529cb910428a8f47a3c06d6fe9ea99"
  enforcement_level = "advisory"
}

policy "iam-no-policies-attached-to-users" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-no-policies-attached-to-users.sentinel?checksum=sha256:101c3110609fbfc9abe2fca333bed6fe6b87b6b3a82942e7e94724968ecfb1fa"
  enforcement_level = "advisory"
}

policy "iam-password-expiry" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-password-expiry.sentinel?checksum=sha256:5b1d51912a7ed111e6c2962e59123c82706df4afd14a6c7974608dde78b61cd4"
  enforcement_level = "advisory"
}

policy "iam-password-length" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-password-length.sentinel?checksum=sha256:96be1cc77018d5da53515764ea072d7f87b5baf1d69c7baa9a22b15123a790bf"
  enforcement_level = "advisory"
}

policy "iam-password-lowercase" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-password-lowercase.sentinel?checksum=sha256:0e21612bb2a6fb0d79e8cc3b6ede723a9c5f56174725a4d25d0023c9fa2fb648"
  enforcement_level = "advisory"
}

policy "iam-password-numbers" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-password-numbers.sentinel?checksum=sha256:44143fda4535b4442b79edb7a01b153c221670ec6d5c29240b20918b49d09bca"
  enforcement_level = "advisory"
}

policy "iam-password-reuse" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-password-reuse.sentinel?checksum=sha256:6dda172f80f2727175e1f826c8fc932dcf03f2c61f32fb86a490910d7ec2a60d"
  enforcement_level = "advisory"
}

policy "iam-password-symbols" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-password-symbols.sentinel?checksum=sha256:03f782921b7511df99ff1d6c740da15c1e6fc8a1207038c3fc044d6554a0c720"
  enforcement_level = "advisory"
}

policy "iam-password-uppercase" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/iam-password-uppercase.sentinel?checksum=sha256:5dc964807496ac535e9d36bd0ed809cffffa39af6c1a75a653aa40795c93f593"
  enforcement_level = "advisory"
}

policy "kms-key-rotation-enabled" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/kms-key-rotation-enabled.sentinel?checksum=sha256:61adb15b95eaaf4eec58988262f370837ba9602f372196e33488705bdd5b1d11"
  enforcement_level = "advisory"
}
...
policy "s3-block-public-access-account-level" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/s3-block-public-access-account-level.sentinel?checksum=sha256:fe9b5590e1f1c80aea63ad14c278f65c2d9a090d50e42f808f7480df229e84b6"
  enforcement_level = "advisory"
}

policy "s3-block-public-access-bucket-level" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/s3-block-public-access-bucket-level.sentinel?checksum=sha256:38cb17fd70b9e87bbc3283cc720458965dca75fc6074c159d301d6f901443ae1"
  enforcement_level = "advisory"
}

policy "s3-enable-object-logging-for-read-events" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/s3-enable-object-logging-for-read-events.sentinel?checksum=sha256:2718f29525fc88251db3ba6a6dfcf0dc1fbc210bc3a79679e305ac493f84fac0"
  enforcement_level = "advisory"
}

policy "s3-enable-object-logging-for-write-events" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/s3-enable-object-logging-for-write-events.sentinel?checksum=sha256:2718f29525fc88251db3ba6a6dfcf0dc1fbc210bc3a79679e305ac493f84fac0"
  enforcement_level = "advisory"
}

policy "s3-require-mfa-delete" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/s3-require-mfa-delete.sentinel?checksum=sha256:4eab349614701a6ca1a66d1ef7b28e8ae41e93dcc2f89978795a0169000979b9"
  enforcement_level = "advisory"
}

policy "s3-require-ssl" {
  source = "https://registry.terraform.io/v2/policies/hashicorp/CIS-Policy-Set-for-AWS-Terraform/1.0.0/policy/s3-require-ssl.sentinel?checksum=sha256:df5bb5db59c8d4300cd3df6394d61bc0d2a9ba8557fb35308b1776ad592498a5"
  enforcement_level = "advisory"
}
